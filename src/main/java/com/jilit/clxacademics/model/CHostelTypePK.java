 ...
 */
@Embeddable
public class CHostelTypePK implements Serializable {
    ...
    public CHostelTypePK() {
    }

    public CHostelTypePK(String institutecode, String hosteltype) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CHostelTypePK)) {
            return false;
        }
        CHostelTypePK other = (CHostelTypePK) object;
    ...
    public String toString() {
        return "com.jilit.clxacademics.model.CHostelTypePK[ institutecode=" + institutecode + ", hosteltype=" + hosteltype + " ]";
    }
